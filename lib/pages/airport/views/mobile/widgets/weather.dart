...
class MAirportWeather extends StatefulWidget {
  MAirportWeather({Key? key, required this.opened}) : super(key: key);
  bool opened;

  @override
  State<MAirportWeather> createState() => _MAirportWeatherState();
}

class _MAirportWeatherState extends State<MAirportWeather> {
  @override
          ...
          Padding(
            ...
            child: TextFormField(
              ...
              controller: TextEditingController()
                ..text = 'Dubai International Airport Dxb/Omdb',
            ),
          ),
          Padding(
            padding: const EdgeInsets.all(8.0),
