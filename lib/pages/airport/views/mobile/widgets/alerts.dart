...
class MAirportsAlerts extends StatefulWidget {
  const MAirportsAlerts({Key? key}) : super(key: key);

  @override
  State<MAirportsAlerts> createState() => _MAirportsAlertsState();
}

class _MAirportsAlertsState extends State<MAirportsAlerts> {
