...
class MAirportDocuments extends StatefulWidget {
  MAirportDocuments({Key? key, required this.opened}) : super(key: key);
  bool opened;

  @override
  State<MAirportDocuments> createState() => _MAirportDocumentsState();
}

class _MAirportDocumentsState extends State<MAirportDocuments> {
  @override
