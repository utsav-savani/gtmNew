...
class ArrivalViewHolder extends StatefulWidget {
  const ArrivalViewHolder({
    Key? key,
    this.onTap,
    required this.item,
  }) : super(key: key);
  ...
  @override
  State<ArrivalViewHolder> createState() => _ArrivalViewHolderState();
}

class _ArrivalViewHolderState extends State<ArrivalViewHolder> {
  bool tba = false;
                        ...
                        child: Row(children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              /// NO ATC RTE on ARRIVAL VIEW HOLDER
