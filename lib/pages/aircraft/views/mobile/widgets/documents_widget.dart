...
class MAircraftDocuments extends StatefulWidget {
  MAircraftDocuments({Key? key, required this.opened}) : super(key: key);
  bool opened;

  @override
  State<MAircraftDocuments> createState() => _MAircraftDocumentsState();
}

class _MAircraftDocumentsState extends State<MAircraftDocuments> {
  @override
