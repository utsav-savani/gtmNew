...
class MDocuments extends StatefulWidget {
  final bool opened;
  const MDocuments({Key? key, required this.opened}) : super(key: key);

  @override
  State<MDocuments> createState() => _MDocumentsState();
}

class _MDocumentsState extends State<MDocuments> {
  @override
