...
class MCountriesSanctions extends StatefulWidget {
  MCountriesSanctions({Key? key, required this.opened}) : super(key: key);
  bool opened;

  @override
  State<MCountriesSanctions> createState() => _MCountriesSanctionsState();
}

class _MCountriesSanctionsState extends State<MCountriesSanctions> {
  @override
